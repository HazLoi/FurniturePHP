            ...
            ?>
                ...
                <div class="content-side col-xl-9 col-lg-8 col-md-12 col-sm-12">
                    <div class="blog-single padding-right">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="assets/images/resource/<?php echo $get['anh'] ?>" alt=""></figure>
                                <span class="date"> <?php
                            ...
                            <div class="lower-content">
                                <div class="post-meta">
                                    <ul class="post-info clearfix">
                                        <li><a href="index.php?action=blog-detail">Nội thất</a></li>
                                    </ul>
                                </div>
                                <div class="lower-box">
                ...
                <aside class="sidebar">
                    ...
                    <div class="sidebar-widget sidebar-blog-category">
                        ...
                        <ul class="cat-list">
                            ...
                            while ($get = $result->fetch()) {
                            ?>
                                <li><a href="index.php?action=shop&act=category&category=<?php echo $get['tenloai'] ?>"><?php echo $get['tenloai'] . " - (" . $get['tongSP'] . ")" ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
