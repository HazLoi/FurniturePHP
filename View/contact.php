    			...
    			<div class="form-column col-lg-7 col-md-12 col-sm-12">
    				<div class="inner-column">
    					...
    					<div class="contact-form">
    						...
    						<!--Contact Form-->
    						<form method="post" action="index.php?action=contact&act=send" id="contact-form">
    							<?php if (isset($_SESSION['idCustomer'])) { ?>
    								<div class="row clearfix">
    									<div class="form-group col-lg-6 col-md-6 col-sm-12">
    										<input type="text" name="fullname" placeholder="Tên của bạn" value="<?php if (isset($_GET['act']) && $_GET['act'] == "send") {
																																			echo $_POST['fullname'];
																																		} else {
																																			echo $_SESSION['fullname'];
																																		} ?>">
    										<span class="error text-danger"><?php if (isset($_GET['act']) && $_GET['act'] == "send") echo $_SESSION['fullnameErrorContact']; ?></span>
    									</div>

    									<div class="form-group col-lg-6 col-md-6 col-sm-12">
    										<input type="text" name="email" placeholder="Địa chỉ email" value="<?php if (isset($_GET['act']) && $_GET['act'] == "send") {
																																			echo $_POST['email'];
																																		} else {
																																			echo $_SESSION['email'];
																																		} ?>">
    										<span class="error text-danger"><?php if (isset($_GET['act']) && $_GET['act'] == "send") echo $_SESSION['emailErrorContact']; ?></span>
    									</div>

    									<div class="form-group col-lg-12 col-md-12 col-sm-12">
    										<input type="text" name="subject" placeholder="Chủ đề" value="<?php if (isset($_GET['act']) && $_GET['act'] == "send") echo $_POST['subject'] ?>">
    										<span class="error text-danger"><?php if (isset($_GET['act']) && $_GET['act'] == "send") echo $_SESSION['subjectErrorContact']; ?></span>
    									</div>
    									...
    									<div class="form-group col-lg-12 col-md-12 col-sm-12">
    										<button class="theme-btn btn-style-one" type="submit" name="submit-form"><span class="txt">Gửi</span></button>
    									</div>
    								</div>
    							<?php } else { ?>
    								<div class="row clearfix">
    									<div class="form-group col-lg-6 col-md-6 col-sm-12">
    										<input type="text" name="fullname" placeholder="Tên của bạn" value="<?php if (isset($_GET['act']) && $_GET['act'] == "send") echo $_POST['fullname']; ?>">
    										<span class="error text-danger"><?php if (isset($_GET['act']) && $_GET['act'] == "send") echo $_SESSION['fullnameErrorContact']; ?></span>
    									</div>

    									<div class="form-group col-lg-6 col-md-6 col-sm-12">
    										<input type="text" name="email" placeholder="Địa chỉ email" value="<?php if (isset($_GET['act']) && $_GET['act'] == "send") echo $_POST['email']; ?>">
    										<span class="error text-danger"><?php if (isset($_GET['act']) && $_GET['act'] == "send") echo $_SESSION['emailErrorContact']; ?></span>
    									</div>
