...
<!-- <div id="search-popup" class="search-popup">
	...
	<div class="popup-inner">
		...
		<div class="search-form">
			<form method="post" action="index.php?action=404">
				<div class="form-group">
					<fieldset>
			...
			<ul class="recent-searches">
				<li><a href="index.php?action=404">Home Interiors</a></li>
				<li><a href="index.php?action=404">Offices Interiors</a></li>
				<li><a href="index.php?action=404">Showroom Interiors</a></li>
				<li><a href="index.php?action=404">Building Interiors</a></li>
				<li><a href="index.php?action=404">Shops Interiors</a></li>
			</ul>
